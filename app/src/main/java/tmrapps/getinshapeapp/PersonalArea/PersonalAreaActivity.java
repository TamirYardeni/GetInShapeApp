...
public class PersonalAreaActivity extends AppCompatActivity implements PersonalAreaFragment.OnFragmentInteractionListener {
    ...
    public Date dateForApiCalendar;

    public void makeCalendarEvent(Date d){
        dateForApiCalendar = d;
        getResultsFromApi();
    }
     ...
     */
    private class MakeRequestTask extends AsyncTask<Void, Void, Date> {
        ...
        private void setNewEvent() throws IOException {
            Event event = new Event()
                    .setSummary("סוף אימון!")
                    .setDescription("תבחר לעצמך תאריך חדש לאימון שלך");

            DateTime startDateTime = new DateTime(dateForApiCalendar);
